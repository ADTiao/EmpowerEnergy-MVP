...
def main():
    ...
    feed = {}
    final = {}
    evaluate_category(example_metrics, "impact", mock_impact, feed, final)
    evaluate_category(example_metrics, "finance", mock_finance, feed, final)
    evaluate_category(example_metrics, "dev", mock_dev, feed, final)
    evaluate_category(example_metrics, "tech", mock_tech, feed, final)
    evaluate_category(example_metrics, "timeline", mock_timeline, feed, final)
    # print(final, feed)
    return evaluate_whole(final, mock_impact_weights, mock_finance_weights, mock_dev_weights, mock_tech_weights,
                          mock_timeline_weights, mock_categ_weights, feed)
